...
namespace project.asp.net.core.Migrations
{
    ...
    [Migration("20211117134247_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("project.asp.net.core.Models.Messanger.MessageModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("project.asp.net.core.Models.Messanger.MessagesModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("project.asp.net.core.Models.Messanger.ReesterModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("project.asp.net.core.Models.Messanger.MessagesModel", b =>
                {
                    b.HasOne("project.asp.net.core.Models.Messanger.MessageModel", "Message")
                        .WithMany()
                        .HasForeignKey("MessageId");

                    b.HasOne("project.Models.UserModel", "Recipient")
                        .WithMany()
            ...
            modelBuilder.Entity("project.asp.net.core.Models.Messanger.ReesterModel", b =>
                {
                    b.HasOne("project.asp.net.core.Models.Messanger.MessagesModel", "LastMessage")
                        .WithMany()
